...
1. Avoid displaying a long list of images before other functionality. This can be problematic for users who navigate using a screen reader or keyboard tabbing.&#x20;
...
2. Ensure your viewer has the following navigation options close to the start of the page, to help users relying on keyboard navigation to explore your item&#x20;
...
14. Maintain a stable layout, avoiding unexpected shifts in the user interface.&#x20;
